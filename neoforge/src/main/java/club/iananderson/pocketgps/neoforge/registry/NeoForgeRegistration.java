...
public class NeoForgeRegistration {
  public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(Registries.ITEM, PocketGps.MOD_ID);
  ...
  public static Supplier<Item> POCKET_GPS = ITEMS.register("gps", () -> new GpsItem(new Item.Properties()));
