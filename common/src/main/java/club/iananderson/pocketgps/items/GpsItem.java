...
public class GpsItem extends Item {
  ...
  public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
    ...
    else loadedMinimap = currentMinimaps.get(0).getModName();
    ...
    else tooltip.add(Component.translatable("item.pocketgps.gps.tooltip.default").withStyle(ChatFormatting.YELLOW));
